...
from eshop_app.views import home, products, account, delivery, confirmation, ordered, cart, register, addproduct, add_to_cart, update_cart, remove_item, remove_product
